                ...
                for(const stationInfo of stationList) {
                    ...
                    if(deviceList){
                        for(const deviceInfo of deviceList) {
                            ...
                            deviceRelatedUpdatePriority = await this.getStatesAsync(stationInfo.stationCode+'.'+deviceInfo.id+'.'+deviceInfo.id.updatePriority+'.'+deviceInfo.id.updatePriority.value);
